**** This do file cleans creates the necessary variables for placebo analysis	****
...
keep if bplcountry!=32040		

gen migrate = 0 if bplcountry==32100
replace migrate = 1 if bplcountry!=32100
label var migrate "=1 if born abroad except India"

gen native = 1 if bplcountry==32100
replace native = 0 if bplcountry!=32100
...
save "${final}pak_1973_temp_placebo.dta", replace
